...
namespace Form_Mbcif.Forms
{
    public partial class Forms : Form
    {
        ...
        public Forms(Form form, Sistema sistema, DataGridView tablaElementos, DataGridView tablaRelaciones, generagrafo gg)
        {
            InitializeComponent();
            this.gg = gg;
            this.form = form;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
           ...
           if (nodo.Text != "Sistema")
           {
               ...
               {    
                   gg.removeallvertex(nombre_textBox.Text);
        ...
        {
            elemento = new Form_Elementos(sistema, tablaElementos, tablaRelaciones, this.gg);
        ...
        {
            relaciones = new Form_Relaciones(sistema, tablaElementos, tablaRelaciones, gg);
