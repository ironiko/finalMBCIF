...
namespace Form_Mbcif
{
    ...
    {
        Sistema sistema;
        Forms.generagrafo gg;
        public Form1()
        {
            InitializeComponent();
            this.gg = new Forms.generagrafo();
            sistema = new Sistema();
            this.tablaElementos.Visible = false;
            this.tablaRelaciones.Visible = false;
        ...
        private void nuevoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Forms.Forms ingreso_sistema = new Forms.Forms(this, sistema, this.tablaElementos, this.tablaRelaciones, gg);
            Forms.Form_Grafo grafo = new Forms.Form_Grafo(gg);
